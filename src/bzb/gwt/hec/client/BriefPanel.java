...
public class BriefPanel extends DialogBox {
	...
	public BriefPanel () {
		...
		if (HomeEnergyCalc.getFormat() == Format.COST) {
			bits = new String[]{"the <span style='font-weight: normal;'>cost</span> of the energy they use at home",
			...
			bits = new String[]{"<span style='font-weight: normal;'>climate change</span>",
					"<span style='font-weight: normal;'>CO<sub>2</sub></span> generated by your daily energy use is",
					...
					"<span style='font-weight: normal;'>climate change</span>",
					"<span style='font-weight: normal;'>CO<sub>2</sub></span> emissions"};
		} else if (HomeEnergyCalc.getFormat() == Format.ENERGY) {
			bits = new String[]{"the <span style='font-weight: normal;'>energy</span> they use at home",
		...
		text = new HTML("<p>Hi!</p>" +
				...
				"<p>The Home Energy Calculator is a tool to help people understand how to reduce " + bits[i++] + ".</p>" +
		...
		text2 = new HTML("<p>The Home Energy Calculator is very easy to use.</p>" +
					...
					"<p>We would then like you to think about how to reduce " + bits[i++] + ". You will be set a 5% reduction target which requires you to revisit the original screen to consider how to reduce your " + bits[i++] + ". Once you've achieved this reduction, you will be able to click on <span style='color: white; font-weight: bold; background: green; padding: 3px; -webkit-border-radius: 3px !important; -moz-border-radius: 3px !important;'>Finish</span> to submit responses and answer some brief final questions.</p>" +
		...
		if (page == 0) {
			...
			cont.addClickHandler(new ClickHandler() {
				public void onClick(ClickEvent event) {
					HomeEnergyCalc.setEmail(email.getText());
					page++;
					updatePage();
				}
			});
