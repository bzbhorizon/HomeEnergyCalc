 ...
 */
if(!isomorphicDir){var isomorphicDir = 'homeenergycalc/sc/';}
...
isc.addGlobal("isA",{});isc.addGlobal("isAn",isc.isA);isc.addGlobal("is",isc.isA);isc.isA.Class="isA";isc.isA.isc=isc.isA;Function.$k=1;Array.$k=2;Date.$k=3;String.$k=4;Number.$k=5;Boolean.$k=6;RegExp.$k=7;Object.$k=8;Function.prototype.$k=1;isc.A=isc.isA;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$bl="object";isc.A.$73x="String";isc.A.$a7="function";isc.A.$bm="text/xml";isc.A.$58k={SelectItem:true,Time:true};isc.B.push(isc.A.emptyString=function isc_isA_emptyString(_1){return isc.isA.String(_1)&&_1==isc.emptyString}
,isc.A.nonemptyString=function isc_isA_nonemptyString(_1){return isc.isA.String(_1)&&_1!=isc.emptyString}
,isc.A.Object=function isc_isA_Object(_1){if(_1==null)return false;if(isc.Browser.isIE&&typeof _1==this.$a7)return false;if(_1.constructor&&_1.constructor.$k!=null){var _2=_1.constructor.$k;if(_2==1){}else{return(_2==8||_2==7||_2==3||_2==2)}}
if(_1.Class!=null&&_1.Class==this.$73x)return false;if(typeof _1==this.$bl){if(isc.Browser.isIE&&isc.isA.Function(_1))return false;else return true}else{if(isc.Browser.isMoz&&isc.isA.RegularExpression(_1))return true;else return false}}
...
,isc.A.String=function isc_isA_String(_1){if(_1==null)return false;if(typeof _1==this.$a7)return false;if(_1.constructor&&_1.constructor.$k!=null){return _1.constructor.$k==4}
if(_1.Class!=null&&_1.Class==this.$73x)return true;return typeof _1=="string"}
,isc.A.Array=function isc_isA_Array(_1){if(_1==null)return false;if(typeof _1==this.$a7)return false;if(_1.constructor&&_1.constructor.$k!=null){return _1.constructor.$k==2}
...
,isc.A.Number=function isc_isA_Number(_1){if(_1==null)return false;if(_1.constructor&&_1.constructor.$k!=null){if(_1.constructor.$k!=5)return false}else{if(typeof _1!="number")return false}
...
,isc.A.$c2=function isc_c_Class__addProto(_1,_2,_3){var _4=_3.$c4=_3.$c4||{},_5=_4[_1];if(_5==null){_4[_1]=_2}else{if(isc.isAn.Array(_5))_5.add(_2);else _4[_1]=[_5,_2]}}
...
,isc.A.getArrayItem=function isc_c_Class_getArrayItem(_1,_2,_3){if(_2==null)return null;if(isc.isA.String(_1))return _2.find(_3||this.$cp,_1);if(isc.isAn.Object(_1))return _1;if(isc.isA.Number(_1))return _2[_1];return null}
...
,isc.A.ignore=function isc_Class_ignore(_1,_2){var _3=isc.$a9[_2];if(_1[_3])this.ignore(_1,_3);var _4=isc.$ah+_2;if(!_1[_4]||!_1.$ba)return false;var _5=_1.$ba[_2],_6=_5.$dh;for(var i=0,_8=_5.length;i<_8;i++){if(_5[i].target==this){if(_6)
_5[i].$di=true;else
_5.removeAt(i);break}}
...
return _12}
,isc.A.$d3=function isc_Class__completeCreationWithDefaults(_1,_2,_3){this.applyBaseDefaults(_2,_1,_3);var _4=this.$d1(_1),_5=this.$543(_1);_2.completeCreation(this.autoChildDefaults,this[_4],_3,this[_5])}
...
);isc.B._maxIndex=isc.C+53;isc.Class.toString=function(){return"[Class "+this.Class+"]"}
...
,isc.A.toLocalizedString=function isc_Numbe_toLocalizedString(_1,_2,_3,_4){var _5=!_1?this:Math.round(this*Math.pow(10,_1))/Math.pow(10,_1);var _6=Math.abs(_5),_7=Math.floor(_6),_8,_9,_10=[];if(_1){var _11=Math.round((_6-_7)*Math.pow(10,_1));_9=_11.stringify(_1)}else if(_1==0){_7=Math.round(_6)}else{if(_6-_7>0){_9=_6.toString().split(this.$eh)[1]}}
_8=_7.toString();var _12=_8.length;var _13=Math.floor(_12/ 3);if(_12%3){_10[0]=_8.substr(0,_12%3)}
for(var i=0;i<_13;i++){_10[_10.length]=_8.substr(_12%3+i*3,3)}
var _15=_10.join(_3||this.localeProperties.groupingSymbol);if(_9)_15=_15+(_2||this.localeProperties.decimalSymbol)+_9;if(_5<0)_15=(_4||this.localeProperties.negativeSymbol)+_15;return _15}
...
return _1}
,isc.A.getFormattedDateRangeString=function isc_Date_getFormattedDateRangeString(_1,_2){var _3=_1?_1.getMonth():null,_4=_1?_1.getShortMonthName():null,_5=_1?_1.getFullYear():null,_6=_2?_2.getMonth():null,_7=_2?_2.getShortMonthName():null,_8=_2?_2.getFullYear():null,_9="";if(_1&&_2){if(_5==_8){if(_3==_6){_9=_4+" "+_1.getDate()+" - "+_2.getDate()+", "+_5}else{_9=_4+" "+_1.getDate()+" - "+_7+" "+_2.getDate()+", "+_5}}else{_9=_4+" "+_1.getDate()+", "+_5+" - "+_7+" "+_2.getDate()+", "+_8}}else if(_1){_9=_4+" "+_1.getDate()+", "+_5}else if(_2){_9=_7+" "+_2.getDate()+", "+_8}
return _9}
);isc.B._maxIndex=isc.C+23;isc.A=Date.prototype;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$em=[,,,,"/",,,,,"/",,,,null];isc.A.$en="MDY";isc.A.$eo="DMY";isc.A.$ep="YMD";isc.A.$en="MDY";isc.A.$68f=[null,null];isc.B.push(isc.A.duplicate=function isc_Dat_duplicate(){var _1=new Date();_1.setTime(this.getTime());_1.logicalDate=this.logicalDate;_1.logicalTime=this.logicalTime;return _1}
...
,isc.A.$es=function isc_Dat__toShortDate(_1,_2){var _3=this.$em,_4,_5,_6;if(!_2){_4=this.getMonth()+1;_5=this.getDate();_6=this.getFullYear()}else{var _7=this.$68g(isc.Time.UTCHoursDisplayOffset,isc.Time.UTCMinutesDisplayOffset);_4=_7.getUTCMonth()+1;_5=_7.getUTCDate();_6=_7.getUTCFullYear()}
...
_4+='\n        "'+_11+'"';return _4},$e6:function(_1){var _2=isc.Func.getBody(_1);return _2.trim()},getStackTrace:function(_1,_2,_3,_4){var _5="";if(isc.Browser.isMoz){}
_5+=this.$76x(_1,_2,_3);if(this.hasFireBug()&&!_4){isc.Log.$50m=isc.Log.$50m||0;var _6="FBugTrace"+isc.Log.$50m++;_5+="\r\n"+this.fireBugTrace(_6)}
...
if(_1==null)_1=arguments.caller||arguments.callee.caller.arguments;var _4=[];var _5=isc.Browser.isIE&&isc.Browser.version<=6;for(var i=0;i<_2;i++){if(!_5){_1=_1.callee.caller.arguments}else{_1=_1.caller}}
...
,isc.A.evaluate=function isc_LogViewer_evaluate(_1,_2){var _3=isc.timeStamp();var _4,_5;if(isc.Log.supportsOnError){_5=isc.Class.evalWithVars(_1,_2,this)}else{try{_5=isc.Class.evalWithVars(_1,_2,this)}catch(e){_4=e}}
...
,isc.A.parseInput=function isc_c_Time_parseInput(_1,_2,_3){var _4=0,_5=0,_6=0,_7=0;var _8=_3?0:this.UTCHoursDisplayOffset,_9=_3?0:this.UTCMinutesDisplayOffset;if(isc.isA.Date(_1)){_3=true;_4=_1.getUTCHours();_5=_1.getUTCMinutes();_6=_1.getUTCSeconds();_7=_1.getUTCMilliseconds()}else if(_1){for(var i=0;i<isc.Time.$he.length;i++){var _11=isc.Time.$he[i].exec(_1);if(_11)break}
...
);isc.B._maxIndex=isc.C+4;isc.A=isc.Page;isc.A.$is={};isc.A.$it=0;isc.A.FIRE_ONCE="once";isc.A.$iu={};isc.A=isc.Page;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$cp="ID";isc.B.push(isc.A.setEvent=function isc_c_Page_setEvent(_1,_2,_3,_4){if(isc.isA.String(_2)){if(_1==isc.EH.LOAD||_1==isc.EH.IDLE||_1==isc.EH.RESIZE)
...
return _5}
,isc.A.clearEvent=function isc_c_Page_clearEvent(_1,_2){if(_2==null){this.$is[_1]=[]}else{if(this.$iv==_1){var _3=this.$is[_1],_4=_3?_3.findIndex(this.$cp,_2):-1;if(_4!=-1)_3[_4]=null}else{if(this.$is[_1])
...
,isc.A.actionsArePendingForEvent=function isc_c_Page_actionsArePendingForEvent(_1){return(this.$is[_1]&&this.$is[_1].length!=0)}
...
,isc.A.handleEvent=function isc_c_EventHandler_handleEvent(_1,_2,_3){var _4=isc.EH;if(isc.Page.handleEvent(_1,_2,_3)==false)return false;if(_4.targetIsEnabled(_1)&&_4.bubbleEvent(_1,_2,_3)==false){return false}
return true}
...
return _5}
,isc.A.cancelKeyEvent=function isc_c_EventHandler_cancelKeyEvent(_1){if(isc.Browser.isIE||isc.Browser.isSafari){if(this.$70a[_1.type]){try{_1.keyCode=0}catch(e){}}}}
...
,isc.A.handleMouseDown=function isc_c_EventHandler_handleMouseDown(_1,_2){var _3=isc.EH;_3.$km=true;var _4=_3.doHandleMouseDown(_1,_2);_3.$km=false;return _4}
...
var _16=_3.dragTarget!=null;var _17=(!_16&&(!(isc.Browser.isMoz||isc.Browser.isSafari)||!!_8.$kr(_4)));return _17}
...
,isc.A.handleMouseUp=function isc_c_EventHandler_handleMouseUp(_1,_2){var _3=isc.EH;if(isc.Browser.isIE&&!_3.$j6){var _4=_3.lastEvent;_4.eventType=_3.MOUSE_DOWN;_3.handleMouseDown(null,_3.lastEvent)}
...
,isc.A.isDoubleClick=function isc_c_EventHandler_isDoubleClick(_1){var _2=this,_1=_1||_2.lastEvent.nativeTarget;var _3=(isc.Browser.isMoz&&isc.Browser.isWin),_4,_5;if(_3){var _6=_2.lastEvent.DOMevent
...
,isc.A._focusInCanvas=function isc_c_EventHandler__focusInCanvas(_1,_2){if(!_1||_1.hasFocus||!_1.$kk()||_1.isDisabled())return;this.checkMaskedFocus(_1);if(_2&&isc.Browser.isMoz){if(_1.parentElement)_1.parentElement.$lh(null,true)}
...
,isc.A.$l3=function isc_c_EventHandler__handleDragScroll(){var _1=this,_2=_1.dragTarget;var _3=[];var _4=_2.dragScrollType=="parentsOnly"?_2.getParentElements():isc.Canvas._canvasList;;if(_4==null||_4.length==0)return;for(var i=0;i<_4.length;i++){if((_4[i].hscrollOn||_4[i].vscrollOn)&&_4[i].isDrawn()&&_4[i].isVisible()&&_4[i].shouldDragScroll()){_3.add(_4[i])}}
...
,isc.A.getEventTargetCanvas=function isc_c_EventHandler_getEventTargetCanvas(_1,_2){if(_1==null)_1={};var _3=this,_4=this.getWindow();if(!_2)_2=(isc.Browser.isIE?_1.srcElement:_1.target);if(!_3.$l7(_2)){return _3.lastTarget}
...
,isc.A.$l7=function isc_c_EventHandler__canAccessNativeTargetProperties(_1){if(!(isc.Browser.isMoz&&_1==this.$jm))return true;if(!this.$l8){this.$l8=new Function("$l9","try{$l9.parentNode}catch(e){return false}return true")}
return this.$l8(_1)}
...
return _11}
);isc.evalBoundary;isc.B.push(isc.A.registerDroppableItem=function isc_c_EventHandler_registerDroppableItem(_1){if(!_1.$ma){this.$i0.add(_1);_1.$ma=true}}
...
,isc.A.eventHandledNatively=function isc_c_EventHandler_eventHandledNatively(_1,_2){var _3=_1;if(!this.reverseEventTypes[_1]){if(this.$i2[_1])
...
return _4}
,isc.A.$md=function isc_c_EventHandler__eventHandledNatively(_1,_2){_1=(_1||"");var _3=this,_4=_3.lastEvent;if(!_3.$l7(_2)){return true}
...
,isc.A.$mf=function isc_c_EventHandler__eventOverCSSScrollbar(_1,_2,_3){var _4=this;if(!_1||_1.showCustomScrollbars||!(_1.vscrollOn||_1.hscrollOn))return false;var _5=isc.Element.getNativeScrollbarSize();if(_1.isRTL()){if((_1.vscrollOn&&(_3.x<_1.getPageLeft()+_5))||(_1.hscrollOn&&(_3.y>_1.getPageTop()+_1.getHeight()-_5)))
...
,isc.A.getKey=function isc_c_EventHandler_getKey(_1){return(_1||this.lastEvent).keyName}
...
return _2}
,isc.A.getElementRect=function isc_c_Element_getElementRect(_1){var _2=this.getDocumentBody(),_3=this.$s4(_1,_2),_4=this.$s5(_1,_2);var _5=0,_6=0;if(_1.style&&_1.style.overflow=="visible"){_5=this.getScrollWidth(_1);_6=this.getScrollHeight(_1)}
...
,isc.A.$s4=function isc_c_Element__getLeftOffsetFromElement(_1,_2,_3){return this.$yw(isc.Canvas.LEFT,_1,_2,_3)}
,isc.A.$s5=function isc_c_Element__getTopOffsetFromElement(_1,_2){return this.$yw(isc.Canvas.TOP,_1,_2)}
,isc.A.$yw=function isc_c_Element__getOffsetFromElement(_1,_2,_3,_4){if(_3==null||_2==null){return 0}
...
,isc.A.getNativeScrollbarSize=function isc_c_Element_getNativeScrollbarSize(){if(isc.Element.$yi==null){var _1="<div id=isc_ScrollbarTest "+"style='position:absolute;top:-100px;border:0px;padding:0px;margin:0px;height:100px;width:100px;overflow:scroll;'>"+isc.nbsp+"</div>";this.createAbsoluteElement(_1);var _2=this.get('isc_ScrollbarTest');isc.Element.$yi=parseInt(_2.style.height)-_2.clientHeight;this.clear(_2)}
...
var _6=this.parentElement;var _7=(!isc.Page.isLoaded()&&!this.drawContext&&(_6==null&&this.position==isc.Canvas.RELATIVE));_7=_7||this.$p2();var _8=this.separateContentInsertion;if(isc.Page.isLoaded()||!_7){this.$p8(!_8);if(_8)this.$p9();this.drawChildren();this.$qa()}else{var _3=this.parentElement;if((isc.Browser.isOpera||isc.Browser.isIE)&&this.getDocument().readyState=="complete")
...
return _1}
);isc.evalBoundary;isc.B.push(isc.A.setDrawContext=function isc_Canvas_setDrawContext(_1){var _2=this.isDrawn();this.deparent();if(_2)this.clear();this.drawContext=_1;if(_2)this.draw()}
...
if(this.useClipDiv){var _10=this.getCurrentCursor(),_11,_12=this._useNativeTabIndex;this.$73u=this.$73v();if(_12&&this.$kk()){_11=isc.SB.concat(_2.$ry,this.$qn(),_2.$rz,this.$qo(),!this.isDisabled()?_2.$r0+this.getTabIndex():null,(!this.$qc()&&this.accessKey!=null)?_2.$r1+this.accessKey:null)}
var _13=isc.StringBuffer.concat("<div id='",this.$rv(),"' eventProxy=",_4,(this.className?" class='"+this.className+"'":""),_11," style='","POSITION:",this.position,";LEFT:",this.left,"px;TOP:",this.top,"px;WIDTH:",_6,"px;HEIGHT:",_7,"px;Z-INDEX:",this.zIndex,(this.visibility==_2.INHERIT?"":";VISIBILITY:"+this.visibility),(this.backgroundColor==null?"":";BACKGROUND-COLOR:"+this.backgroundColor),(this.backgroundImage==null?"":";BACKGROUND-IMAGE:url("+this.getImgURL(this.backgroundImage)+")"+";BACKGROUND-REPEAT:"+this.backgroundRepeat+(this.backgroundPosition?";BACKGROUND-POSITION:"+this.backgroundPosition:"")),(this.border?";BORDER:"+this.border:""),(this.padding!=null||this.$415?";PADDING:0px":""),this.$r2(),(_9!=null?(this.$65q?";-moz-opacity:":";opacity:")+_9:""),(_8?";-moz-box-sizing:border-box":null),(_8&&_12&&this.mozOutlineOffset!=null?";-moz-outline-offset:"+this.mozOutlineOffset:null),(_8&&_12&&this.mozOutlineColor!=null?";-moz-outline-color:"+this.mozOutlineColor:null),(_8&&_12&&!this.showFocusOutline?";-moz-outline-style:none":null),";OVERFLOW:",_3,";' ONSCROLL='return "+_4+".$lh()'>","<div id='",this.getCanvasName(),"' eventProxy='",_4,(this.textDirection!=null?"' dir='"+this.textDirection:""),"' style='POSITION:relative;VISIBILITY:inherit",this.$73u?";FLOAT:"+this.$73u:"",";Z-INDEX:",this.zIndex,(_10==_2.AUTO?"":";CURSOR:"+_10),(this.padding!=null?";PADDING:"+this.padding+"px":""),(this.topPadding!=null?";padding-top:"+this.topPadding+"px":""),(this.bottomPadding!=null?";padding-bottom:"+this.bottomPadding+"px":""),(this.leftPadding!=null?";padding-left:"+this.leftPadding+"px":""),(this.rightPadding!=null?";padding-right:"+this.rightPadding+"px":""),";'>")}else{if(!_2.$r4){_2.$r5=" style='POSITION:absolute;LEFT:";_2.$r6=" style='POSITION:relative;LEFT:";_2.$bd=" class='";_2.$416="'";_2.$r7=";VISIBILITY:";_2.$r8=";CURSOR:";var _14=_2.$r4=[];_14[0]="<div id=";_14[2]=" eventProxy=";_14[15]="px;TOP:";_14[22]="px;WIDTH:";_14[28]="px;HEIGHT:";_14[34]="px;Z-INDEX:";_14[44]=";OVERFLOW:";_14[59]="' ONSCROLL='return ";_14[61]=".$lh()' "}
var _14=_2.$r4;_14[1]=this.getCanvasName();_14[3]=_4;if(this.className!=null){_14[4]=_2.$bd;_14[5]=this.className;_14[6]=_2.$416}else{_14[4]=_14[5]=_14[6]=null}
_14[7]=(this.textDirection!=null?" dir="+this.textDirection:null);_14[8]=(this.position==_2.RELATIVE?_2.$r6:_2.$r5);isc.$bk(_14,this.left,9,6);isc.$bk(_14,this.top,16,6);isc.$bk(_14,_6,23,5);isc.$bk(_14,_7,29,5);if(this.zIndex!=_2.AUTO)isc.$bk(_14,this.zIndex,35,9);else{_14[35]=this.zIndex;_14[36]=_14[37]=_14[38]=_14[39]=_14[40]=_14[41]=_14[42]=_14[43]=null}
_14[45]=_3;if(this.visibility!=_2.INHERIT){_14[46]=_2.$r7;_14[47]=this.visibility}else{_14[46]=_14[47]=null}
_14[48]=(this.backgroundColor==null?null:";BACKGROUND-COLOR:"+this.backgroundColor);_14[49]=(this.backgroundImage==null?null:";BACKGROUND-IMAGE:url("+this.getImgURL(this.backgroundImage)+");BACKGROUND-REPEAT:"+this.backgroundRepeat+(this.backgroundPosition?";BACKGROUND-POSITION:"+this.backgroundPosition:""));_14[50]=(_8?";-moz-box-sizing:border-box":null);var _10=this.getCurrentCursor();if(_10==_2.AUTO){_14[51]=_14[52]=null}else{_14[51]=_2.$r8;_14[52]=_10}
_14[53]=this.$r2();_14[54]=(this.padding!=null?";PADDING:"+this.padding+isc.px:null);if(this.topPadding!=null)
...
,isc.A.getCanvasLeft=function isc_Canvas_getCanvasLeft(){if(!this.isDrawn()){if(this.position==isc.Canvas.RELATIVE){this.logWarn("getCanvasLeft(): Called on undrawn relatively-position widget '"+this.getID()+"'.  The drawn coordinates can not be reliably "+"calculated until the widget has drawn - returning estimated position")}
return this.left}
...
return this.$s4()}
);isc.evalBoundary;isc.B.push(isc.A.$s4=function isc_Canvas__getLeftOffsetFromElement(_1){if(_1==null)_1=this.getDocumentBody();var _2=this.ns.Element.$s4(this.getClipHandle(),_1,this.isRTL());return _2}
,isc.A.getCanvasTop=function isc_Canvas_getCanvasTop(){if(!this.isDrawn()){if(this.position==isc.Canvas.RELATIVE){this.logWarn("getCanvasTop(): Called on undrawn relatively-position widget '"+this.getID()+"'.  The drawn coordinates can not be reliably "+"calculated until the widget has drawn - returning estimated position")}
return this.top}
...
return this.$s5()}
,isc.A.$s5=function isc_Canvas__getTopOffsetFromElement(_1){if(_1==null)_1=this.getDocumentBody();var _2=this.ns.Element.$s5(this.getClipHandle(),_1);return _2}
...
,isc.A.$sd=function isc_Canvas__calculateMargins(){var _1=this.$sc,_2=(_1!=null),_3,_4,_5,_6;if(_2){_3=_1.top;_6=_1.bottom;_4=_1.left;_5=_1.right;if((!_3||_3.length==0)&&(!_6||_6.length==0)&&(!_4||_4.length==0)&&(!_5||_5.length==0))_2=false}
...
{return false}}
return true}
,isc.A.visibleAtPoint=function isc_Canvas_visibleAtPoint(_1,_2,_3,_4){if(isc.$cv)arguments.$cw=this;if(!this.containsPoint(_1,_2,_3)){return false}
...
,isc.A.getScrollbarSize=function isc_Canvas_getScrollbarSize(){if(this.showCustomScrollbars)return this.scrollbarSize;return isc.Element.getNativeScrollbarSize()}
...
,isc.A.parentMoved=function isc_Canvas_parentMoved(_1,_2,_3){this.$t3(_1,_2,_3)}
...
,isc.A.pageResize=function isc_Canvas_pageResize(){this.$rq=null;this.$p0=null;this.$qw()}
...
,isc.A.innerSizeChanged=function isc_Canvas_innerSizeChanged(_1){this.layoutChildren(_1);var _2=this.peers;if(_2){for(var i=0;i<_2.length;i++){if(!_2[i].percentSource&&_2[i].snapTo&&_2[i].percentBox==this.$520)
{_2[i].$qw()}}}}
...
);isc.evalBoundary;isc.B.push(isc.A.finishTargetResize=function isc_Canvas_finishTargetResize(_1,_2,_3){if(_3)return;_2?_1.setHeight(this.$ug):_1.setWidth(this.$ug)}
...
,isc.A.prepareForDragging=function isc_Canvas_prepareForDragging(){var _1=this.ns.EH;if(_1.dragTarget)return;if(this.canDragResize){_1.resizeEdge=this.getEventEdge();if(_1.resizeEdge){_1.dragTarget=this;_1.dragOperation=_1.DRAG_RESIZE;_1.dragMoveAction=_1.$mq}}
...
,isc.A.$l5=function isc_Canvas__setupDragScroll(_1){if(this.$ul!=null)return;var _2=(this.getOffsetY()-this.getScrollTop()),_3=(this.getOffsetX()-this.getScrollLeft()),_4=this.$uk(_3),_5=this.$uj(_2);this.$ul=isc.Timer.setTimeout({target:this,methodName:"$um",args:[_4,_5,true,_1]},this.dragScrollDelay)}
,isc.A.$um=function isc_Canvas__performDragScroll(_1,_2,_3,_4){this.$ul=null;var _5=0,_6=0;if(this.ns.EH.dragging&&this.containsEvent()){var _7=this.getOffsetX()-this.getScrollLeft(),_8=this.getOffsetY()-this.getScrollTop(),_9=this.getViewportWidth(),_10=this.getViewportHeight();if(!isc.isA.Number(this.maxDragScrollIncrement)){var _11=parseInt(this.maxDragScrollIncrement);if(!isc.isA.Number(_11))
...
,isc.A.$u6=function isc_Canvas__scrolled(){if(!isc.EH.$ky){var _1=isc.EH.lastEvent,_2=(_1.eventType==isc.EH.MOUSE_MOVE?_1.target:isc.EH.lastMoveTarget);if(_2!=null){if(!this.contains(_2,true))_2=null;else if(_1.eventType!=isc.EH.MOUSE_MOVE&&!_2.visibleAtPoint(isc.EH.getX(),isc.EH.getY(),false))
{_2=null}
...
,isc.A.getTextDirection=function isc_Canvas_getTextDirection(){var _1=this;while(_1){if(_1.textDirection!=null)return _1.textDirection;_1=_1.parentElement;if(_1&&_1.eventProxy)_1=_1.eventProxy}
...
,isc.A.parentVisibilityChanged=function isc_Canvas_parentVisibilityChanged(_1){if(this.children)this.children.map("parentVisibilityChanged",_1);this.$ve();if(this==isc.Canvas.$rl)isc.Canvas.hideResizeThumbs();if(this.$kn)this.$vg()}
...
,isc.A.$ve=function isc_Canvas__updateHandleDisplay(){if(!this.hideUsingDisplayNone||!this.isDrawn())return;var _1=this.getStyleHandle();if(!this.isVisible()&&!this.$62u){this.$vh=_1.display;this.$62u=true;_1.display=this.$27r}else if(this.isVisible()&&this.$62u){_1.display=(this.$vh?this.$vh:isc.emptyString);delete this.$62u}}
...
);isc.evalBoundary;isc.B.push(isc.A.enable=function isc_Canvas_enable(){if(this.disabled)this.setDisabled(false)}
...
,isc.A.hilite=function isc_Canvas_hilite(){isc.Log.hiliteCanvas(this.ID)}
...
,isc.A.handleHover=function isc_Canvas_handleHover(){if(this.hover&&this.hover()==false)return;if(this.showHover){var _1=this.getHoverHTML();if(_1!=null&&!isc.isAn.emptyString(_1)){var _2=this.$wc();isc.Hover.show(_1,_2,null,this)}}}
...
,isc.A.setStyleName=function isc_Canvas_setStyleName(_1){this.$tk=null;this.$tp=null;if(_1){this.styleName=_1;this.className=_1}
...
,isc.A.showContextMenu=function isc_Canvas_showContextMenu(){var _1=this.contextMenu;if(_1){_1.target=this;if(!isc.isA.Canvas(_1)){_1.autoDraw=false;this.contextMenu=_1=isc.Menu.create(_1)}
_1.showContextMenu()}
return(_1==null)}
...
,isc.A.handleMouseDown=function isc_Canvas_handleMouseDown(_1,_2){if(_1.target==this&&this.useEventParts)this.firePartEvent(_1,isc.EH.MOUSE_DOWN);if(this.mouseDown)return this.mouseDown(_1,_2)}
...
);isc.evalBoundary;isc.B.push(isc.A.getGroupLabelBackgroundColor=function isc_Canvas_getGroupLabelBackgroundColor(){if(this.groupLabelBackgroundColor)return this.groupLabelBackgroundColor;if(this.backgroundColor!=null)return this.backgroundColor;return"white"}
...
,isc.A.$xo=function isc_c_Canvas__fixPNG(_1){if(this.usePNGFix==false)return false;var _2=isc.Browser.isIE&&isc.Browser.minorVersion>=5.5&&isc.Browser.isWin&&this.neverUsePNGWorkaround!=true;if(_2&&_1&&_1.$xo&&!_1.$xo()){_2=false}
return _2}
...
);isc.B._maxIndex=isc.C+4;isc.defineClass("ScreenSpan","Canvas");isc.A=isc.ScreenSpan.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A._generated=true;isc.A.redrawOnResize=false;isc.A.overflow="hidden";isc.B.push(isc.A.getInnerHTML=function isc_ScreenSpan_getInnerHTML(){if(!this.$yy){this.$yy=isc.Browser.isIE&&isc.Browser.version>6?isc.Canvas.blankImgHTML(1600,1200):isc.Canvas.spacerHTML(1600,1200)}
return this.$yy}
...
,isc.A.setTitle=function isc_PrintCanvas_setTitle(_1){this.title=_1;if(!this.iframeLoaded)return}
...
,isc.A.bindToDataSource=function isc_Canvas_bindToDataSource(_1){if(this.dataPath)this.setDataPath(this.dataPath);if(this.dataSource==null&&this.data!=null)this.dataSource=this.data.dataSource;var _2=this.fields||this.items;if(isc.isAn.Array(_2))this.originalFields=_2.duplicate();var _3=this.getDataSource();if(_3!=null&&isc.isA.String(_3)){this.logWarn("unable to look up DataSource: "+_3+", databinding will not be used");return _1}
...
this.addFieldValidators(_1);return _1}
if(_3!=null&&!_4){if(this.useAllDataSourceFields){var _10=this;var _11=_3.combineFieldOrders(_5,_1,function(_9,_3){return _10.shouldUseField(_9,_3)});this.addFieldValidators(_11);return _11}else{for(var i=0;i<_1.length;i++){var _9=_1[i];if(!_9)continue;var _8=_9[this.fieldIdProperty];isc.SimpleType.addTypeDefaults(_9);_9=this.combineFieldData(_9)}
this.addFieldValidators(_1);return _1}}}
,isc.A.combineFieldData=function isc_Canvas_combineFieldData(_1){var _2=this.getDataSource();if(_1.dataPath){isc.DataSource.combineFieldData(_1,this.getDataPathField(_1.dataPath));return _1}else if(_2.getField(_1.name)){return _2.combineFieldData(_1)}
return _1}
...
,isc.A.addFieldValidators=function isc_Canvas_addFieldValidators(_1){if(_1==null)return;var _2={type:"required"};for(var i=0;i<_1.length;i++){var _4=_1[i];if(_4.required){var _5=isc.addProperties({},_2),_6=_4.requiredMessage||this.requiredMessage;if(_6!=null)_5.errorMessage=_6;if(!_4.validators){_4.validators=[_5]}else{if(!isc.isAn.Array(_4.validators)){_4.validators=[_4.validators]}
if(!_4.validators.containsProperty("type",_5.type)){if(_4.validators.$69){_4.validators=_4.validators.duplicate()}
_4.validators.add(_5)}else if(_6!=null){var _7=this.getDataSource(),v=_4.validators.find("type",_5.type);if(v.errorMessage==null||(_7&&v.errorMessage==_7.requiredMessage)){v.errorMessage=_6}}}}}}
...
if(_7.width!=null&&!isNaN(_7.width))_8.width=_7.width;if(_7.title)_8.title=_7.title;if(_7.userFormula!=null)_8.userFormula=_7.userFormula;if(_7.userSummary!=null)_8.userSummary=_7.userSummary;_5.add(_8)}
...
,isc.A.addField=function isc_Canvas_addField(_1,_2){if(_1==null)return;var _3=(this.fields||this.items||isc.$ac).duplicate();var _4=this.getField(_1.name);if(_4)_3.remove(_4);if(_2==null||_2>_3.length)_2=_3.length;_3.addAt(_1,_2);this.setFields(_3)}
,isc.A.removeField=function isc_Canvas_removeField(_1){var _2=(this.fields||this.items||isc.$ac).duplicate();var _3=_1.name?_1.name:_1;_2.remove(_2.find("name",_3));this.setFields(_2)}
...
,isc.A.selectSingleRecord=function isc_Canvas_selectSingleRecord(_1){this.deselectAllRecords();this.selectRecord(_1)}
...
,isc.A.selectAllRecords=function isc_Canvas_selectAllRecords(){this.selection.selectAll()}
,isc.A.deselectAllRecords=function isc_Canvas_deselectAllRecords(){this.selection.deselectAll()}
...
return _3}
,isc.A.evaluateCriterion=function isc_Canvas_evaluateCriterion(_1,_2){var _3=isc.DataSource.$57z.find("ID",_2.operator);if(_3==null){isc.logWarn("Attempted to use unknown operator "+_2.operator);return false}
return _3.condition(_2.value,_1,_2.fieldName,_2,_3,this)}
,isc.A.hiliteRecord=function isc_Canvas_hiliteRecord(_1,_2,_3){var _4=_1[this.hiliteMarker];if(_4==null)_4=_1[this.hiliteMarker]=this.$578++;var _5=_2.$58c=_2.$58c||{},_6=_5[_4];if(_6==null)_5[_4]=_3.id;else _5[_4]=[_6,_3.id]}
...
,isc.A.addHiliteCSSText=function isc_Canvas_addHiliteCSSText(_1,_2,_3){if(!_1)return _3;var _4=_1[this.hiliteMarker],_5=this.getField(_2);if(!_5||!_5.$58c)return _3;var _6=_5.$58c[_4];if(_6==null)return _3;if(!isc.isAn.Array(_6)){this.$579[0]=_6;_6=this.$579}
...
for(var i=0;i<_4.length;i++){var _6,_7,_8,_9=_4[i];if(isc.isA.String(_9))_6=_9;else _6=(_9!=null?_9[this.hiliteProperty]:null);_7=this.getHilite(_6);if(_7!=null&&!_7.disabled){_8=_7.cssText||_7.style;var _10=(!_7.fieldName||!_3||_7.fieldName==_3.name);if(_8!=null&&_8!=isc.emptyString&&_10){if(_2==null)_2=_8;else _2+=isc.semi+_8}}}
return _2}
,isc.A.getFieldHilites=function isc_Canvas_getFieldHilites(_1,_2){if(!_1||!_2)return null;if(_1[this.hiliteProperty]!=null){var _3=this.getHilite(_1[this.hiliteProperty]);if(_3&&_3.fieldName==_2.name)return[_3];else return null}
...
if(_7)_8=_7.getPrimaryKeyFields();if(_7&&_7==_2){var _11;if(_8&&isc.firstKey(_8)!=null){for(var _12 in _8){if(_8[_12].type=="sequence"){_11=true;break}}}
...
if(_7&&_2==_7){if(_8&&isc.firstKey(_8)!=null){var _14=isc.applyMask(_1,_8)}else{_14=this.getCleanRecordData(_1)}}else if(_4&&isc.firstKey(_4)){_14=isc.addProperties({},this.data.getCriteria());isc.addProperties(_14,_4)}else{_14=this.getCleanRecordData(_1)}
isc.Log.logDebug("Incrementing dup query count: was "+_9.$67l,"dragDrop");this.$67l++;_7.fetchData(_14,function(_15,_16,_17){if(_16&&_16.length>0){isc.warn(_9.duplicateDragMessage);isc.Log.logDebug("Found server-side duplicate, adding '"+_1[isc.firstKey(_1)]+"' to exception list","dragDrop");_9.$67n.add(_9.getCleanRecordData(_1))}else{if(!_3.$67v)_3.$67v=0;_3.$67v++;_7.addData(_1,function(_15,_16,_17){_3.$67w(_15,_16,_17)},_10)}
...
);isc.evalBoundary;isc.B.push(isc.A.getCleanRecordData=function isc_Canvas_getCleanRecordData(_1){if(isc.ResultTree&&isc.isA.ResultTree(this.data)){return this.data.getCleanNodeData(_1,false)}
...
delete _4.$29a}
if(isc.isA.ResultTree(this.data)||isc.isA.Tree(this.data)){_1=this.data.getCleanNodeData(_1)}else{if(isc.isAn.Array(_1)){_1=isc.shallowClone(_1)}else{_1=isc.addProperties({},_1)}}}
return _1}
...
,isc.A.editFormulaField=function isc_Canvas_editFormulaField(_1){if(isc.FormulaBuilder==null)return;var _2=this,_3=!_1?false:true;if(!_3){_1={name:_2.getUniqueFieldName("formulaField"),title:"New Field",width:"50",canFilter:false,canExport:false,canSortClientOnly:true}}
...
,isc.A.getUniqueFieldName=function isc_Canvas_getUniqueFieldName(_1){if(!_1||_1=="")_1="field";var _2=this.getFields(),_3=1,_4=_1.length;for(var i=0;i<_2.length;i++){var _6=_2.get(i);if(_6.name.startsWith(_1)){var _7=_6.name.substr(_4),_8=new Number(_7);if(_8&&_8>=_3)_3=_8+1}}
return _1+_3}
...
,isc.A.getRecordHiliteCSSText=function isc_Canvas_getRecordHiliteCSSText(_1,_2,_3){if(_3!=null&&_3.userSummary){var _4=isc.SummaryBuilder.getFieldDetailsFromValue(_3.userSummary.summaryVars,this.getAllFields(),this),_5=_4.usedFields;for(var _6=0;_6<_5.length;_6++){_2=this.getRecordHiliteCSSText(_1,_2,_5[_6])}}
_2=this.addObjectHilites(_1,_2,_3);_2=this.addHiliteCSSText(_1,this.getFieldNum(_3),_2);return _2}
...
,isc.A.getExportFieldValue=function isc_Canvas_getExportFieldValue(_1,_2,_3){return this.getSpecificFieldValue(_1,_2,false)}
,isc.A.getClientExportData=function isc_Canvas_getClientExportData(_1){var _2=this.originalData||this.data,_3=[],_4=this.getClientExportFields(_1),_5,_6,_7;if(isc.isA.Object(_1)){_5=_1.includeHiddenFields;_6=_1.allowedProperties;_7=_1.includeCollapsedNodes;if(_1&&_1.exportFields){if(_5!==false)_5=true}}
if(isc.isA.ResultSet(_2))_2=_2.getAllLoadedRows();if(isc.isA.ResultTree(_2)){if(_7)_2=_2.getAllNodes();else _2=_2.getOpenList()}
for(var _8=0;_8<_2.getLength();_8++){var _9=_2[_8],_10=this.getRecordExportObject(_9,_4,_6,_5,_7);_3.push(_10)}
if(this.showGridSummary&&this.summaryRow&&this.exportIncludeSummaries){var _11=this.summaryRow,_2=[_11.$71q];for(var _8=0;_8<_2.getLength();_8++){var _9=_2[_8],_10=this.getRecordExportObject(_9,_4,_6,_5,_7);_3.push(_10)}}
return _3}
...
_2=_3}}
return _2}
,isc.A.getRecordExportObject=function isc_Canvas_getRecordExportObject(_1,_2,_3,_4,_5){var _6={}
for(var _7=0;_7<_2.length;_7++){var _8=_2[_7];if((!this.fields.contains(_8))&&!_4)continue;var _9=_8.title||_8.name,_10=this.getExportFieldValue(_1,_8.name,_7);if(_10==null||_10=="&nbsp;")_10="";_10=this.htmlUnescapeExportFieldValue(_10);var _11=this.htmlUnescapeExportFieldTitle(_9);_6[_11]=_10;var _12=this.getRecordHiliteCSSText(_1,null,_8),_13=this.convertCSSToProperties(_12,_3);if(_13){isc.addProperties(_13,this.getFormattingProperties(_8,_1[_8.name]))}else{_13=this.getFormattingProperties(_8,_1[_8.name])}
if(_13)_6[_11+"$style"]=_13}
return _6}
...
,isc.A.exportClientData=function isc_Canvas_exportClientData(_1){var _2=this.getClientExportData(_1),_3=_1,_4=_3&&_3.exportAs?_3.exportAs:"csv",_5=_3&&_3.exportFilename?_3.exportFilename:"export",_6=_3&&_3.exportDisplay?_3.exportDisplay:"download";var _7={showPrompt:false,transport:"hiddenFrame",exportResults:true,downloadResult:true,downloadToNewWindow:(_6=="window"),download_filename:(_6=="window"?_5:null)};isc.DMI.callBuiltin({methodName:"downloadClientExport",arguments:[_2,_4,_5,_6],requestParams:_7})}
...
,isc.A.validateFieldAndDependencies=function isc_Canvas_validateFieldAndDependencies(_1,_2,_3,_4,_5){var _6={},_7=false,_8={valid:true,errors:null,resultingValue:null};_4[_1.name]=_3;var _9=this.validateField(_1,_1.validators,_3,_4,_5);if(_9!=null){_8.valid=_9.valid;_8.stopOnError=_9.stopOnError;if(_9.errors!=null){this.addValidationError(_6,_1.name,_9.errors)}
if(_9.resultingValue!=null){_8.resultingValue=_9.resultingValue;_4[_1.name]=_9.resultingValue}
_7=true}
var _10=_1.name,_11=this.getFields()||[];for(var i=0;i<_11.length;i++){var _13=_11[i];if(_13.name!=_10&&this.isFieldDependentOnOtherField(_13,_10)){_9=this.validateField(_13,_13.validators,_4[_13.name],_4,_5);if(_9!=null){if(_9.errors!=null){this.addValidationError(_6,_13.name,_9.errors)}else{this.addValidationError(_6,_13.name,null)}
...
_7=true;var _17=(isc.Validator.processValidator(_1,_13,_3,null,_4)==true);isc.Validator.performAction(_17,_1,_13,this);if(!_17){var _18=isc.Validator.getErrorMessage(_13);if(_18==null&&_5&&_5.unknownErrorMessage){_18=_5.unknownErrorMessage}
...
if(_10){_11=this.$75e(_11,_1.stopOnError,this.stopOnError);var _19=((_5&&_5.serverValidationMode)?_5.serverValidationMode:this.$746),_20=isc.addProperties({},_4),_21=(_11||_1.synchronousValidation||this.synchronousValidation||false);_20[_1.name]=_3;this.fireServerValidation(_1,_20,_19,_21)}
...
,isc.A.fireServerValidation=function isc_Canvas_fireServerValidation(_1,_2,_3,_4){var _5=this.getDataSource();if(_5!=null){var _6={showPrompt:_4,prompt:isc.RPCManager.validateDataPrompt,validationMode:_3,clientContext:{component:this,fieldName:_1.name}};if(!_4){var _7=this.$75c(_1);_6.clientContext.pendingFields=_7}
_5.validateData(_2,this.$742,_6)}}
...
);isc.B._maxIndex=isc.C+9;isc.ClassFactory.defineClass("Hover");isc.A=isc.Hover;isc.A.delay=500;isc.A.leftOffset=15;isc.A.topOffset=15;isc.A.hoverCanvasDefaults={defaultWidth:100,defaultHeight:1,baseStyle:"canvasHover",align:isc.Canvas.LEFT,valign:isc.Canvas.TOP,wrap:true,autoDraw:false};isc.A=isc.Hover;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.show=function isc_c_Hover_show(_1,_2,_3,_4){if(!this.hoverCanvas)this.$zf();var _5=this.hoverCanvas;if(_1==null||_1==""){_5.hide();return}
...
return}
,isc.A.hoverCanvasHidden=function isc_c_Hover_hoverCanvasHidden(){var _1=this.lastHoverCanvas;delete this.lastHoverCanvas;if(_1!=null){_1.hoverHidden()}}
...
_5.append("{");for(var _7 in _1){if(_7==null)continue;if(this.skipInternalProperties&&(isc.startsWith(_7,isc.$ag)||isc.startsWith(_7,isc.$75g)))continue;var _9=_1[_7];if(isc.isA.Function(_9))continue;if(_7!=isc.gwtRef&&isc.isAn.Instance(_9)&&this.serializeInstances=="skip")continue;var _10=_7.toString();if(!isc.Comm.$zk.test(_10)||this.strictQuoting)_10='"'+_10+'"';var _2=isc.JSONEncoder.$zp(_2,_7);var _11;if(_7==isc.gwtRef){if(!this.showDebugOutput)continue;_11="{GWT Java Obj}"}else{_11=this.$eu(_9,(_4!=null?_4+isc.Comm.indent:null),_2)}
...
,isc.A.getBaseComponentFromLocatorSubstring=function isc_c_AutoTest_getBaseComponentFromLocatorSubstring(_1){var _2=_1.match("(.*)\\[")[1];if(_2=="autoID"){var _3=isc.AutoTest.parseLocatorFallbackPath(_1),_4=_3.config,_5="name",_6="Class";return isc.Canvas.getCanvasFromFallbackLocator(_1,_4,isc.Canvas.$tw,_5,_6)}else{var _7=_2,_8=_1.match('ID=\\"(.*)\\"')[1];var _9=window[_8];if(!_9)return null;if(_9&&_7!="*any*"&&(!isc.isA[_7]||!isc.isA[_7](_9)))
{this.logWarn("AutoTest.getElement(): Component:"+_9+" expected to be of class:"+_7)}
return _9}}
...
);isc.B._maxIndex=isc.C+10;isc.ApplyAutoTestMethods=function(){isc.Canvas.addClassMethods({getCanvasLocatorFallbackPath:function(_9,_39,_148,_149,_150){if(_149==null)_149={};if(_150==null)_150={};else if(isc.isAn.Array(_150)){var _1={};for(var i=0;i<_150.length;i++){_1[_150[i]]=_150[i]}
_150=_1}
if(_150.title==null)_150.title="title";if(_150.scRole==null)_150.scRole="waiRole";if(_150.name==null)_150.name="name";var _3=_39.getClassName(),_4=_39.getClass();_149.Class=_3;var _5;if(!_4.isFrameworkClass){_5=_4.$750}
if(_5!=null)_149.scClass=_5;if(_148!=null){_149.index=_148.indexOf(_39);_149.length=_148.length;var _6=_148.findAll("Class",_3);_149.classIndex=_6.indexOf(_39);_149.classLength=_6.length;if(_5!=null){var _7=_148.findAll("$75y",_5);_149.scClassIndex=_7.indexOf(_39);_149.scClassLength=_7.length}
if(_39.waiRole!=null){var _8=_148.findAll("waiRole",_39.waiRole);_149.roleIndex=_8.indexOf(_39);_149.roleLength=_8.length}}
return isc.AutoTest.getObjectLocatorFallbackPath(_9,_39,_149,_150)},getCanvasFromFallbackLocator:function(_148,_43,_44,_45,_46){var _9=_43.name;var _10=_43.Class,_5=_43.scClass||_43.Class,_11=_43.scRole;switch(_45){case"name":if(_9!=null){var _12=_44.find("name",_9);if(_12){switch(_46){case"Class":if(_10&&isc.isA[_10]&&isc.isA[_10](_12)){if(this.logIsDebugEnabled("AutoTest")){this.logDebug("Locator string:"+_148+" - returning widget with matching name and ClassName:"+_12,"AutoTest")}
return _12}
case"scClass":if(_5&&isc.isA[_5]&&isc.isA[_5](_12))
{if(this.logIsDebugEnabled("AutoTest")){this.logDebug("Locator string:"+_148+" - returning widget with matching name and scClassName:"+_12,"AutoTest")}
return _12}
case"role":var _13=_43.scRole;if(_12.waiRole==_13){if(this.logIsDebugEnabled("AutoTest")){this.logDebug("Locator string:"+_148+" - returning widget with matching name and role:"+_12,"AutoTest")}
return _12}
default:if(_46!="none"){isc.AutoTest.logRobustLocatorWarning();this.logWarn("Locator string:"+_148+". Returning closest match:"+_12+". This has the same name "+"as the recorded component but does not match class or role. ","AutoTest")}else{if(this.logIsDebugEnabled("AutoTest")){this.logDebug("Locator string:"+_148+" - returning widget with matching name:"+_12,"AutoTest")}}
return _12}}}
...
_16=_17[0];if(_17.length==1&&_16){if(this.logIsDebugEnabled("AutoTest")){this.logDebug("Locator string:"+_148+" - returning widget with matching name and scClassName:"+_16,"AutoTest")}
return _16}}}
case"role":if(_11){var _17=_15.findAll("waiRole",_11);if(_17!=null){if(_17.length==1||_16==null)
_16=_17[0];if(_17.length==1&&_16){if(this.logIsDebugEnabled("AutoTest")){this.logDebug("Locator string:"+_148+" - returning widget with matching title and role:"+_16,"AutoTest")}
return _16}}}
default:if(_15.length==1){if(_46!="none"){isc.AutoTest.logRobustLocatorWarning();this.logWarn("Locator string:"+_148+". Returning closest match:"+_15[0]+". This has the same title "+"as the recorded component but does not match class or role.","AutoTest")}else{if(this.logIsDebugEnabled("AutoTest")){this.logDebug("Locator string:"+_148+" - returning widget with matching title:"+_16,"AutoTest")}}
return _15[0]}else{this.logWarn("Locator string:"+_148+", attempt to match by title failed -- multiple candidate components have this "+"same title. Attempting to match by index instead.","AutoTest")}}}}
default:var _18,_19,_20;switch(_46){case"Class":if(_10&&_43.classIndex){var _21=_44.findAll("Class",_10);if(_21&&_21.length>0){_18=_21[parseInt(_43.classIndex)];if(_21.length==parseInt(_43.classLength)){if(this.logIsInfoEnabled("AutoTest")){this.logInfo("Locator string:"+_148+" - returning widget with matching ClassName / index by ClassName:"+_18,"AutoTest")}
return _18}}}
...
return _19}}}
case"role":if(_11&&_43.roleIndex){var _23=_44.findAll("waiRole",_11);if(_23&&_23.length>0){_20=_23[parseInt(_43.roleIndex)];if(_23.length==parseInt(_43.roleLength)){if(this.logIsInfoEnabled("AutoTest")){this.logInfo("Locator string:"+_148+" - returning widget with matching role / index by role:"+_20,"AutoTest")}
return _20}}}
...
if(_24){this.logWarn("Locator string:"+_148+" matching by index gave "+_24+". Reliability cannot be guaranteed for matching by index if the underlying "+"application undergoes any changes.","AutoTest");return _24}}}
this.logDebug("AutoTest.getElement(): locator substring:"+_148+" parsed to fallback locator name:"+_9+", unable to find relevant child - may refer to inner element.","AutoTest")}});isc.Canvas.addMethods({getLocator:function(_50,_148){var _26,_27;if(this._generated||this.locatorParent||this.creator||this.$541){_27=this.getLocatorParent()}
if(!_27){_26=this.getLocatorRoot()}else{_26=_27.getLocator()+"/"+_27.getChildLocator(this)}
if(_50)return[_26,this.getInteriorLocator(_50,_148)].join("/");return _26},$549:["//",,'[ID="',,'"]'],getLocatorRoot:function(){if(!this.locatorRoot){if(this.$541&&this.parentElement==null){this.locatorRoot="//"+isc.Canvas.getCanvasLocatorFallbackPath("autoID",this,isc.Canvas.$tw)}else{this.$549[1]=this.getClassName();this.$549[3]=this.getID();this.locatorRoot=this.$549.join(isc.emptyString)}}
...
return this.getStandardChildLocator(_39)},getCanvasLocatorFallbackPath:function(_9,_39,_148,_149,_150){return isc.Canvas.getCanvasLocatorFallbackPath(_9,_39,_148,_149,_150)},getAutoChildLocator:function(_39){if(this.$542){var _30=_39.getID();for(var _31 in this.$542){var _32=this.$542[_31];if(_32.contains(_30)){if(_39==this[_31])return _31;else{var _33=[];for(var i=0;i<_32.length;i++){_33[i]=window[_32[i]]}
...
if(_39==this[_34]){return _9}}}},getStandardChildLocator:function(_39){var _35=this.getNamedLocatorChildString(_39);if(_35)return _35;if(_39.masterElement==this){return this.getCanvasLocatorFallbackPath("peer",_39,this.peers)}else if(_39.parentElement==this){return this.getCanvasLocatorFallbackPath("child",_39,this.children)}else{this.logWarn("unexpected error - failed to find relationship between parent:"+this.getID()+" and child:"+_39.getID());return _39.getLocatorRoot()}},getInteriorLocator:function(_50,_148){if(_50&&this.useEventParts){var _36=this.getElementPart(_50);if(_36!=null&&_36.part!=null){return(_36.partID&&_36.partID!=isc.emptyString)?_36.part+"_"+_36.partID:_36.part}}
return isc.emptyString},getElementFromSplitLocator:function(_148){var _37=this.getChildFromLocatorSubstring(_148[0],0,_148);if(_37){_148.removeAt(0);return _37.getElementFromSplitLocator(_148)}
return this.getInnerElementFromSplitLocator(_148)},getChildFromLocatorSubstring:function(_148,_25,_149){if(_148==null||_148=="")return null;if(isc.isA.Canvas(this[_148])){return this[_148]}
if(this.namedLocatorChildren!=null){var _38=this.namedLocatorChildren.find("name",_148);if(_38!=null){var _39=this[_38.attribute];if(isc.isA.Canvas(_39))return _39;this.logWarn("Locator substring:"+_148+" remaps to attribute:"+_38.attribute+" but no canvas exists under that attribute name.","AutoTest")}}
var _40=isc.AutoTest.parseLocatorFallbackPath(_148);if(_40!=null){return this.getChildFromFallbackLocator(_148,_40)}
return null},getChildLocatorStrategy:function(_148){if(isc.AutoTest.locStrategyNames==null){isc.AutoTest.locStrategyNames={}}
var _34=isc.AutoTest.locStrategyNames[_148];if(_34==null){var _41=_148;if(this.$558[_148])_41=this.$558[_148];_34=isc.AutoTest.locStrategyNames[_148]="locate"+_41.substring(0,1).toUpperCase()+_41.substring(1)+"By"}
return this[_34]},getChildLocatorTypeStrategy:function(_148){if(isc.AutoTest.locStrategyTypes==null){isc.AutoTest.locStrategyTypes={}}
var _34=isc.AutoTest.locStrategyTypes[_148];if(_34==null){var _41=_148;if(this.$558[_148])_41=this.$558[_148];_34=isc.AutoTest.locStrategyTypes[_148]="locate"+_41.substring(0,1).toUpperCase()+_41.substring(1)+"Type"}
return this[_34]},getChildFromFallbackLocator:function(_148,_40){var _42=_40.name,_43=_40.config;var _44=this.getFallbackLocatorCandidates(_42);if(_44&&_44.length>0){var _45=this.getChildLocatorStrategy(_42);if(_45==null)_45="name";var _46=this.getChildLocatorTypeStrategy(_42);if(_46==null)_46="Class";var _24=isc.Canvas.getCanvasFromFallbackLocator(_148,_43,_44,_45,_46);if(_24!=null)return _24}
this.logDebug("AutoTest.getElement(): locator substring:"+_148+" parsed to fallback locator name:"+_42+", unable to find relevant child - may refer to inner element.","AutoTest")},$558:{peer:"peers",child:"children"},getFallbackLocatorCandidates:function(_9){var _44;if(this.$542!=null&&this.$542[_9]!=null){var _47=this.$542[_9];_44=[];for(var i=0;i<_47.length;i++){_44[i]=window[_47[i]]}}else if(this.$558[_9]!=null){_44=this[this.$558[_9]]}else if(this[_9]&&isc.isAn.Array(this[_9])){_44=this[_9]}
return _44},emptyLocatorArray:function(_148){return _148==null||_148.length==0||(_148.length==1&&_148[0]=="")},getInnerElementFromSplitLocator:function(_148){if(!this.emptyLocatorArray(_148)){if(_148.length==1){var _48=_148[0].split("_");var _49={part:_48[0],partID:_48[1]};var _50=this.getPartElement(_49);if(_50)return _50}}
return this.getHandle()}});if(isc.Layout){isc.Layout.addProperties({getStandardChildLocator:function(_39){var _35=this.getNamedLocatorChildString(_39);if(_35)return _35;if(this.members.contains(_39)){return this.getCanvasLocatorFallbackPath("member",_39,this.members)}
return this.Super("getStandardChildLocator",arguments)},$558:{member:"members",peer:"peers",child:"children"}})}
if(isc.Window){isc.Window.addProperties({containsLocatorChild:function(_39){if(this.items&&this.items.contains(_39))return true;return this.Super("containsLocatorChild",arguments)},getStandardChildLocator:function(_39){if(this.items&&this.items.contains(_39)){var _51=this.$55a;_51[0]="item";_51[2]=this.items.indexOf(_39);_51[4]=_39.getClassName();return _51.join(isc.emptyString)}
return this.invokeSuper(isc.Window,"getStandardChildLocator",_39)},$558:{item:"items",member:"members",peer:"peers",child:"children"}})}
if(isc.SectionStack){isc.ImgSectionHeader.changeDefaults("$558",{item:"items"});isc.SectionHeader.changeDefaults("$558",{item:"items"});isc.SectionStack.changeDefaults("$558",{section:"sections"});isc.SectionStack.addProperties({getStandardChildLocator:function(_39){var _52=this.sections||[],_53;for(var i=0;i<_52.length;i++){var _54=_52[i].items,_55,_56;if(_39==_52[i]){_55=_39}else if(_54&&_54.contains(_39)){_55=_52[i];_56=_39}
if(_55!=null){_53=this.getCanvasLocatorFallbackPath("section",_55,this.sections)}
if(_56!=null){_53+="/"+this.getCanvasLocatorFallbackPath("item",_56,_55.items)}
if(_53!=null)return _53}
return this.Super("getStandardChildLocator",arguments)}})}
if(isc.StretchImg){isc.StretchImg.addProperties({getInteriorLocator:function(_50,_148){var _57=_50,_58=this.getHandle(),_59=this.getCanvasName();while(_50&&_50!=_58&&_50.getAttribute){var _30=_50.getAttribute("name");if(_30&&_30.startsWith(_59)){return _30.substring(_59.length)}
_50=_50.parentNode}
return this.Super("getInteriorLocator",[_57,_148])},getInnerElementFromSplitLocator:function(_148){if(!this.emptyLocatorArray(_148)&&_148.length==1){var _60=this.getImage(_148[0]);if(_60)return _60}
return this.Super("getInnerElementFromSplitLocator",arguments)}})}
if(isc.DynamicForm){isc.DynamicForm.addProperties({getInteriorLocator:function(_50){var _61=isc.DynamicForm.$mu(_50,this);if(!_61.item)return this.Super("getInteriorLocator",arguments);var _56=_61.item,_62=[this.getItemLocator(_56),'/'];if(_61.overElement)_62[_62.length]="element";else if(_61.overTitle)_62[_62.length]="title";else if(_61.overTextBox)_62[_62.length]="textbox";else if(_61.overControlTable)_62[_62.length]="controltable";else if(_61.overIcon)_62[_62.length]="[icon='"+_61.overIcon+"']"
return _62.join(isc.emptyString)},getItemLocator:function(_56){if(_56.parentItem&&(_56.parentItem!=this)){return this.getItemLocator(_56.parentItem)+"/"+_56.parentItem.getItemLocator(_56)}
var _63={};if(_56.name!=null)_63.name=_56.name;var _14=_56.getTitle();if(_14!=null)_63.title=_14;var _64=_56.getValue();if(_64!=null)_63.value=_64;_63.index=this.getItems().indexOf(_56);_63.Class=_56.getClassName();var _65=isc.AutoTest.createLocatorFallbackPath("item",_63);return _65},containsLocatorChild:function(_39){if(isc.isA.DateChooser(_39)&&_39.callingForm==this)return true;return this.Super("containsLocatorChild",arguments)},getChildLocator:function(_39){if(_39.canvasItem){var _56=_39.canvasItem;return this.getItemLocator(_56)+"/canvas"}
if(isc.isA.PickListMenu(_39)){var _56=_39.formItem;return this.getItemLocator(_56)+"/pickList"}
if(isc.isA.DateChooser(_39)){var _56=_39.callingFormItem;return this.getItemLocator(_56)+"/picker"}
return this.Super("getChildLocator",arguments)},getItemFromSplitLocator:function(_148){var _66=_148[0],_10;if(_66.contains("[Class=")){var _67=_66.match("item\\[(.+)'\\]\\[Class=\"(.+)\"\\]");_10=_67[1].substring(6,_67[1].length-2);_66=_67[0]}
var _68=isc.AutoTest.parseLocatorFallbackPath(_66);if(_68&&_68.name=="item"&&_68.config!=null){var _43=_68.config;_10=_43.Class;var _56;if(_43.name!=null){_56=this.getItem(_43.name)}else{for(var i=0;i<this.items.length;i++){var _69=this.items[i],_70=_69.locateItemBy;if(_70==null)_70="title";if(_70=="title"&&_43.title!=null&&_69.title==_43.title)
{_56=_69}else if(_70=="value"&&_43.value!=null&&_69.getValue()==_43.value)
{_56=_69}}
if(_56==null){var _25=_43.index;if(isc.isA.String(_25)){if(_25.startsWith("'")||_25.startsWith('"'))
{_25=_25.substring(1)}
_25=parseInt(_25)}
_56=this.items[_25]}}
if(!_56){this.logWarn("AutoTest.getElement(): Unable to find item from "+"locator string:"+_66);return null}
if(!isc.isA[_10]||!isc.isA[_10](_56)){this.logWarn("AutoTest.getElement(): identifier:"+_66+" returned an item of class:"+_56.getClassName())}
return _56}
return null},getInnerElementFromSplitLocator:function(_148){if(this.emptyLocatorArray(_148)){return this.getHandle()}
var _56=this.getItemFromSplitLocator(_148);if(_56!=null){_148.removeAt(0);return _56.getInnerElementFromSplitLocator(_148)}
return this.getHandle()}});isc.ContainerItem.addProperties({getItemLocator:isc.DynamicForm.getPrototype().getItemLocator,getItemFromSplitLocator:isc.DynamicForm.getPrototype().getItemFromSplitLocator,getInnerElementFromSplitLocator:function(_148){if(!this.emptyLocatorArray(_148)){var _71=this.getItemFromSplitLocator(_148);if(_71!=null){_148.removeAt(0);return _71.getInnerElementFromSplitLocator(_148)}}
return this.Super("getInnerElementFromSplitLocator",arguments)}});isc.FormItem.addProperties({getInnerElementFromSplitLocator:function(_148){if(!this.emptyLocatorArray(_148)){var _49=_148[0];if(_49=="element")return this.getDataElement();if(_49=="title")return this.form.getTitleCell(this);if(_49=="textbox")return this.$15h();if(_49=="controltable")return this.$56a();if(_49=="canvas"){if(this.canvas){_148.removeAt(0);return this.canvas.getElementFromSplitLocator(_148)}}
if(_49=="picker"){if(this.picker){_148.removeAt(0);return this.picker.getElementFromSplitLocator(_148)}}
if(_49=="pickList"){if(!this.pickList)this.makePickList(false);_148.removeAt(0);return this.pickList.getElementFromSplitLocator(_148)}
var _72=_49.match("\\[icon='(.+)'\\]"),_73=_72?_72[1]:null;if(_73){return this.$16v(_73)}}},emptyLocatorArray:isc.Canvas.getPrototype().emptyLocatorArray});isc.HeaderItem.addProperties({locateItemBy:"value"});if(isc.PickListMenu){isc.PickListMenu.addProperties({getLocatorParent:function(){if(this.formItem)return this.formItem.form;return this.Super("getLocatorParent",arguments)}})}}
if(isc.GridRenderer){isc.GridRenderer.addProperties({getInteriorLocator:function(_50,_148){var _74=this.getCellFromDomElement(_50);if(_74==null)return this.Super("getInteriorLocator",[_50,_148]);var _75=_74[0],_76=_74[1];return this.getCellLocator(_75,_76)},getCellFromDomElement:function(_50){var _58=this.getHandle(),_77=this.getTableElement();if(!_77)return null;var _78=_77.rows,_79,_80,_74,_81="tr",_82="TR",_83="td",_84="TD";while(_50&&_50!=_77&&_50!=_58){_79=_50.tagName;if(_79==_83||_79==_84){_74=_50}
if(_79==_81||_79==_82){_80=_50}
_50=_50.parentNode}
if(!_80||!_74)return null;var _78=_77.rows,_75,_85;for(var i=0;i<_78.length;i++){if(_78[i]==_80){_75=i;break}}
var _86=_80.cells,_76,_87;for(var i=0;i<_86.length;i++){if(_86[i]==_74){_76=i;break}}
_85=_75+(this.$252||0);_87=_76+(this.$254||0);return[_85,_87]},getCellLocator:function(_75,_76){return"row["+_75+"]/col["+_76+"]"},getInnerElementFromSplitLocator:function(_148){if(this.emptyLocatorArray(_148))return this.getHandle();if(_148.length==2){var _74=this.getCellFromLocator(_148[0],_148[1]),_75=_74[0],_76=_74[1];if(isc.isA.Number(_75)&&isc.isA.Number(_76)){if(this.$29p())return null;return this.getTableElement(_75,_76)}}
return this.Super("getInnerElementFromSplitLocator",arguments)},getCellFromLocator:function(_106,_103){var _88=_106.substring(4,_106.length-1),_89=_103.substring(4,_103.length-1);return[_75,_76]}})}
if(isc.ListGrid){isc.ListGrid.addProperties({namedLocatorChildren:["header","frozenHeader","body","frozenBody",{attribute:"$286",name:"editRowForm"}]});isc.GridBody.addProperties({getInteriorLocator:function(_50,_148){if(_148){var _32=this.children;if(_32!=null&&_32.length>0){for(var i=0;i<_32.length;i++){var _37=_32[i];if(_37&&_37.eventProxy==this){var _58=_37.getHandle();if(_58!=null){var _90=_50;while(_90!=this.getHandle()&&_90!=null)
{if(_90==_58){var _75=this.getEventRow(),_76=this.getEventColumn();return this.getCellLocator(_75,_76)}
_90=_90.parentNode}}}}}}
return this.Super("getInteriorLocator",arguments)},getCellLocator:function(_75,_76){var _91=this.grid;if(_91==null)return this.Super("getCellLocator",arguments);return _91.getCellLocator(this,_75,_76)}});isc.ListGrid.addProperties({getCellLocator:function(_102,_75,_76){var _92=this.getRowLocatorOptions(_102,_75,_76),_93=this.getColLocatorOptions(_102,_75,_76);return isc.AutoTest.createLocatorFallbackPath("row",_92)+"/"+isc.AutoTest.createLocatorFallbackPath("col",_93)},getRowLocatorOptions:function(_102,_75,_76){var _94={},_95=this.getFieldNumFromLocal(_76,_102),_96=this.getCellRecord(_75,_95),_97=this.getDataSource();if(_96!=null){if(_97!=null){var _98=_97.getPrimaryKeyFieldName();if(_98!=null&&_96[_98]!=null){_94[_98]=_96[_98]}}
var _99=this.getTitleField();if(_99!=null&&_96[_99]!=null){_94[_99]=_96[_99]}
var _100=this.getFieldName(_95);if(_100!=null&&_96[_100]!=null){_94[_100]=_96[_100]}}
_94[isc.AutoTest.fallback_valueOnlyField]=_75;return _94},getColLocatorOptions:function(_102,_75,_76){var _94={},_95=this.getFieldNumFromLocal(_76,_102);var _101=this.getField(_95);if(this.isCheckboxField(_101)){_94.isCheckboxField=true}else{var _100=this.getFieldName(_95);if(_100!=null)_94.fieldName=_100}
_94[isc.AutoTest.fallback_valueOnlyField]=_76;return _94},getChildFromLocatorSubstring:function(_148,_25,_149){if(_148=="frozenBody"||_148=="body"){if(_149.length==_25+3&&_149[_25+1].startsWith("row[")&&_149[_25+2].startsWith("col["))
{return null}}
return this.Super("getChildFromLocatorSubstring",arguments)},getInnerElementFromSplitLocator:function(_148){if(this.emptyLocatorArray(_148))return this.getHandle();var _102=_148[0];if(_148.length==3&&(_102=="body"||_102=="frozenBody")){var _103=_148[2],_104=isc.AutoTest.parseLocatorFallbackPath(_103);if(_104.name!="col"){this.logWarn("Error parsing locator:"+_148.join("")+" returning ListGrid handle");return this.getHandle()}
var _101=this.getFieldFromColLocatorConfig(_104.config),_105;if(_101==null){_105=parseInt(_104.config[isc.AutoTest.fallback_valueOnlyField]);if(_102=="frozenBody"&&this.frozenBody==null){_102="body"}
_102=this[_102]}else{_105=this.getLocalFieldNum(this.getFieldNum(_101));if(this.fieldIsFrozen(_101))_102=this.frozenBody;else _102=this.body}
var _106=_148[1],_107=isc.AutoTest.parseLocatorFallbackPath(_106),_75=this.getRowNumFromLocatorConfig(_107.config);if(isc.isA.Number(_75)&&isc.isA.Number(_105)){if(_102.$29p())return null;return _102.getTableElement(_75,_105)}}
return this.Super("getInnerElementFromSplitLocator",arguments)},getFieldFromColLocatorConfig:function(_148){if(_148.isCheckboxField!=null){for(var i=0;i<this.fields.length;i++){if(this.isCheckboxField(this.fields[i])){return this.fields[i]}
this.logWarn("AutoTest stored a locator for interaction with "+"checkbox field - but this grid is not showing a checkbox field - "+"recorded test may be invalid.","AutoTest");return-1}}else{var _108=this.locateColumnsBy;if(_108=="fieldName"||_108==null){var _100=_148.fieldName;if(_100!=null){return this.getField(_100)}}}},getRowNumFromLocatorConfig:function(_148){var _109=this.locateRowsBy;if(_109==null)_109="primaryKey";switch(_109){case"primaryKey":var _97=this.getDataSource();if(_97!=null){var _110=_97.getPrimaryKeyFieldName();if(_97!=null&&_148[_110]!=null){return this.findRowNum(_148)}}
case"titleField":var _99=this.getTitleField();if(_99!=null&&_148[_99]!=null){var _111=this.data;return _111.findIndex(_99,_148[_99])}
case"targetCellValue":for(var _100 in _148){if(_100==isc.AutoTest.fallback_valueOnlyField)continue;if(_148[_100]!=null){return this.data.findIndex(_100,_148[_100])}}
default:return parseInt(_148[isc.AutoTest.fallback_valueOnlyField])}}})}
if(isc.TreeGrid){isc.TreeGridBody.addProperties({getInteriorLocator:function(_50){var _57=_50;var _58=this.getHandle(),_112=this.getTableElement();if(!_50||!_58||!_112)return isc.emptyString;var _113=this.grid.getCanvasName()+this.grid.$34l,_75,_76;var _114=this.grid.getCanvasName()+this.grid.$349;while(_50!=this.tableElement&&_50!=_58&&_50.getAttribute){var _30=_50.getAttribute("name");if(_30){if(_30.startsWith(_113)){_75=parseInt(_30.substring(_113.length));_76=this.grid.getTreeFieldNum();return this.getCellLocator(_75,_76)+"/open"}
if(_30.startsWith(_114)){_75=parseInt(_30.substring(_114.length));_76=this.grid.getTreeFieldNum();return this.getCellLocator(_75,_76)+"/extra"}}
_50=_50.parentNode}
return this.Super("getInteriorLocator",[_57])},getInnerElementFromSplitLocator:function(_148){if(this.emptyLocatorArray(_148))return this.getHandle();if(_148.length==3){if(_148[2]=="open"){if(this.$29p())return null;var _106=_148[0];var _75;if(_106.charAt(3)!="["){_75=parseInt(_106.substring(3))}else{var _107=isc.AutoTest.parseLocatorFallbackPath(_106);if(_107==null||_107.name!="row"){this.logInfo("Locator appears to be click-in-open-area locator but "+"doesn't contain row/col info? returning null.\n"+_148.join("/"),"AutoTest")}
_75=this.grid.getRowNumFromLocatorConfig(_107.config)}
var _115=this.grid.$34l+_75,_60=this.grid.getImage(_115);if(_60)return _60}else if(_148[2]=="extra"){if(this.$29p())return null;var _106=_148[0];var _75;if(_106.charAt(3)!="["){_75=parseInt(_106.substring(3))}else{var _107=isc.AutoTest.parseLocatorFallbackPath(_106);if(_107==null||_107.name!="row"){this.logInfo("Locator appears to be click-in-open-area locator but "+"doesn't contain row/col info? returning null.\n"+_148.join("/"),"AutoTest")}
_75=this.grid.getRowNumFromLocatorConfig(_107.config)}
var _115=this.grid.$349+_75,_60=this.grid.getImage(_115);if(_60)return _60}}
return this.Super("getInnerElementFromSplitLocator",arguments)}})}
if(isc.TabSet){isc.TabSet.addProperties({containsLocatorChild:function(_39){if(this.Super("containsLocatorChild",arguments))return true;if(this.getTabNumber(_39)!=-1)return true;return false},getStandardChildLocator:function(_39){var _116=this.getTabNumber(_39);if(_116!=-1){var _117=this.getTabObject(_116);var _118={};if(_117.ID!=null)_118.ID=_117.ID;if(_117.title!=null)_118.title=_117.title;_118.index=_116;return isc.AutoTest.createLocatorFallbackPath("tab",_118)}
return this.Super("getStandardChildLocator",arguments)},getChildFromLocatorSubstring:function(_148){if(_148&&_148.startsWith("tab[")){var _119=isc.AutoTest.parseLocatorFallbackPath(_148),_43=_119.config;if(_43.ID!=null){return this.getTab(_43.ID)}
var _120=this.locateTabsBy;if(_120==null)_120="title";if(_43.title&&_120=="title"){var _116=this.tabs.findIndex("title",_43.title);return this.getTab(_116)}
return this.getTab(parseInt(_43.index))}
return this.Super("getChildFromLocatorSubstring",arguments)}})}
if(isc.StatefulCanvas){isc.StatefulCanvas.addProperties({getInnerElementFromSplitLocator:function(_148){if(!this.emptyLocatorArray(_148)&&this.label){return this.label.getInnerElementFromSplitLocator(_148)}
return this.Super("getInnerElementFromSplitLocator",arguments)}})}
if(isc.DateChooser){isc.DateChooser.addMethods({getInteriorLocator:function(_50){var _58=this.getHandle();if(!_58||!_50)return"";var _121=_50.$73l;if(_121!=null&&_121!="")return _121;return _50.$73l=this.$73m(_50,_58)},$73m:function(_50,_58){var _122=_50;while(_122&&_122!=null){if(_122==_58){_122=null;break}
if(_122.tagName&&_122.tagName.toLowerCase()=="td"){break}
_122=_122.parentElement}
if(_122==null)return"";var _123=_58.childNodes,_124=[];for(var i=0;i<_123.length;i++){if(!_123[i].tagName||_123[i].tagName.toLowerCase()!="table"){continue}
_124[_124.length]=_123[i]}
var _125=_124.length==2?_124[0]:null,_126=_124.length==2?_124[1]:_124[0];if(_125!=null&&_122.offsetParent==_125){var _127=_122.onclick,_128=_127?_127.toString():null;if(!_128)return"";if(_128.contains("showPrevYear")){return"prevYearButton"}else if(_128.contains("showNextYear")){return"nextYearButton"}else if(_128.contains("showPrevMonth")){return"prevMonthButton"}else if(_128.contains("showNextMonth")){return"nextMonthButton"}else if(_128.contains("showMonthMenu")){return"monthMenuButton"}else if(_128.contains("showYearMenu")){return"yearMenuButton"}
return""}else if(_126!=null&&_122.offsetParent==_126){var _127=_122.onclick,_128=_127?_127.toString():null;if(!_128)return"";if(_128.contains("cancelClick"))return"cancelButton";else if(_128.contains("todayClick"))return"todayButton";else{var _129=_128.match("dateClick\\(\(.*\)\\)");if(_129&&_129[1]){var _130=_129[1].split(",");for(var i=0;i<_130.length;i++){_130[i]=_130[i].trim()}
return _130.join("/")}}}
return""},getInnerElementFromSplitLocator:function(_148){if(this.emptyLocatorArray(_148))return this.getHandle();var _58=this.getHandle();if(_58==null)return;var _131=(_148.length==3);if(!_131){var _53=_148[0];if(_53=="")return _58;var _132=(_53=="todayButton"),_133=!_132?(_53=="cancelButton"):false;var _123=_58.childNodes;if(_132||_133){if(_132&&!this.showTodayButton){this.logWarn("DateChooser attempting to locate element for "+"'todayButton' but showTodayButton is false. Returning handle.","AutoTest");return _58}
if(_133&&!this.showCancelButton){this.logWarn("DateChooser attempting to locate element for "+"'cancelButton' but showCancelButton is false. Returning handle.","AutoTest");return _58}
var _126;for(var i=_123.length-1;i>=0;i--){if(_123[i].tagName&&_123[i].tagName.toLowerCase()=="table")
{_126=_123[i];break}}
var _134=_126.rows[_126.rows.length-1],_86=_134.cells;for(var i=0;i<_86.length;i++){if(this.getInteriorLocator(_86[i])==_53){return _86[i]}}}else{if(!this.showHeader){this.logWarn("DateChooser attempting to locate element for "+_148+" but this.showHeader is false so this element will not be present. "+"Returning handle.","AutoTest");return _58}
var _125
for(var i=0;i<_123.length;i++){if(_123[i].tagName&&_123[i].tagName.toLowerCase()=="table")
{_125=_123[i];break}}
var _80=_125.rows[0],_86=_80.cells;for(var i=0;i<_86.length;i++){if(this.getInteriorLocator(_86[i])==_53){return _86[i]}}}}else{var _135=_148[0],_136=_148[1],_137=_148[2];if((_135==this.year)&&(this.month==_136||this.month==_136+1||this.month==_136-1))
{var _138=new Date(_135,_136,_137),_139=_138.getDay();if(this.showWeekends||!Date.getWeekendDays().contains(_139)){var _140=new Date(this.year,this.month,1);var _141=_140.getDay(),_142=_141+this.firstDayOfWeek-
(_141<this.firstDayOfWeek?7:0);_140.setDate(_140.getDate()-_142);if(Date.compareDates(_138,_140)!=1){var _143=new Date(this.year,this.month+1,1);_143.setTime(_143.getTime()-86400000);var _144=_143.getDay(),_145=this.firstDayOfWeek+6;if(_145>6)_145-=7;var _146=_145>_144?_145-_144:_145+7-_144;if(_146!=0){_143.setTime(_143.getTime()+(86400000*_146))}
if(Date.compareDates(_138,_143)!=-1){var _75=Math.floor(((parseInt(_137)+_142)/7))
_75+=1;var _147=this.firstDayOfWeek;if(!this.showWeekends){while(Date.getWeekendDays().contains(_147)){_147+=1;if(_147==7)_147=0}}
var _76=_138.getDay()-_147;if(_76<0)_76+=7;var _123=_58.childNodes,_126;for(var i=_123.length-1;i>=0;i--){if(_123[i].tagName&&_123[i].tagName.toLowerCase()=="table")
{_126=_123[i];break}}
if(_126)return _126.rows[_75].cells[_76]}else{this.logInfo("DateChooser Passed ID for a date after end. "+"end date:"+[_143.getFullYear(),_143.getMonth(),_143.getDay()]+" vs:"+[_135,_136,_137],"AutoTest")}}else{this.logInfo("DateChooser Passed ID for a date before start date. "+"startDate:"+[_140.getFullYear(),_140.getMonth(),_140.getDay()]+" vs:"+[_135,_136,_137],"AutoTest")}}else{this.logInfo("DateChooser Passed ID for a weekend - not showing weekends","AutoTest")}}else{this.logInfo("DateChooser passed ID for the wrong year or month - passed:"+_148+", showing:"+[this.year,this.month],"AutoTest")}
this.logWarn("DateChooser - passed inner locator for date ("+_148.join("/")+") -- not currently showing this date.","AutoTest")}
this.logWarn("DateChooser, unable to find element for inner locator:"+_148+" returning handle");return _58}})}}
isc.AutoTest.customizeCalendar=function(){isc.$755={getRowLocatorOptions:function(_48,_28,_29){var _1=this.Super("getRowLocatorOptions",arguments);var _2=this.creator.chosenDate;_1.date=_2.toSchemaDate("date");_1.minutes=_28*30;return _1},getRowNumFromLocatorConfig:function(_48){var _3=this.creator.locateCellsBy;if((_3=="date"||_3==null)&&_48.date!=null)
{var _2=isc.Date.parseSchemaDate(_48.date);if(!this.showingDate(_2)){this.logWarn("Locator for cell in this calendar day-view grid has date "+"stored as:"+_2.toUSShortDate()+", but we're currently showing "+this.creator.chosenDate.toUSShortDate()+". The stored date doesn't map to a visible cell so not returning a cell "+"- if this is not the intended behavior in this test case you may need to "+"set calendar.locateCellsBy to 'index'.","AutoTest");return-1}
return parseInt(_48.minutes)/30}
...
this.logWarn("doesn't contain date:"+_2);return false},getColLocatorOptions:function(_48,_28,_29){var _6=this.Super("getColLocatorOptions",arguments),_7=this.getFieldNumFromLocal(_29,_48),_5=this.getField(_7);if(_5&&_5.$658!=null){_6.date=[_5.$66a,(_5.$659+1),_5.$658].join("-")}
return _6},getFieldFromColLocatorConfig:function(_48){if((this.locateCellsBy=="date"||this.locateCellsBy==null)&&(_48.date!=null))
{var _8=_48.date.split("-");return this.getFields().find("$658",_8[2])}
return this.Super("getFieldFromColLocatorConfig",arguments)}});isc.MonthSchedule.addProperties({getRowLocatorOptions:function(_48,_28,_29){var _1=this.Super("getRowLocatorOptions",arguments);var _9=this.getRecord(_28);if(!_9)return _1;var _5=this.getField(_29);var _10=_5.$66b;_1.dayIndex=_10;var _2=_9["date"+_10];_1.date=_2.toSchemaDate("date");var _11=_9["event"+_10];if(_11==null){_1.isHeaderRow=true}else{_1.isHeaderRow=false}
return _1},getRowNumFromLocatorConfig:function(_48){var _3=this.creator.locateCellsBy;if((_3=="date"||_3==null)&&_48.date!=null)
{var _2=isc.Date.parseSchemaDate(_48.date),_12=(_48.isHeaderRow=="true"),_13="date"+_48.dayIndex,_14="event"+_48.dayIndex;for(var i=0;i<this.data.length;i++){var _15=(this.data[i][_14]==null);if(_15==_12){if(Date.compareLogicalDates(this.data[i][_13],_2)==0){return i}}}
return-1}
this.locateRowsBy="index";return this.Super("getRowNumFromLocatorConfig",arguments)},getColLocatorOptions:function(_48,_28,_29){var _1=this.Super("getColLocatorOptions",arguments);_1.dayIndex=this.getField(_29).$66b;return _1},getColNumFromLocatorConfig:function(_48){var _3=this.locateCellsBy;if(_3==null||_3=="date"){return this.fields.findIndex("$66b",parseInt(_48.dayIndex))}
this.locateColsBy="index";return this.Super("getColNumFromLocatorConfig",arguments)}});isc.MonthScheduleBody.addProperties({getInteriorLocator:function(_48){if(_48.tagName.toLowerCase()=="a"){var _16=_48.href;if(_16!=null){var _17=_16.match("javascript:.*monthViewEventClick\\((\\d+),(\\d+),(\\d+)\\);");if(_17){var _18=parseInt(_17[1]),_19=parseInt(_17[2]),_20=parseInt(_17[3]);var _11=this.grid.getEvents(_18,_19),_21=_11[_20];if(_21==null){this.logWarn("Unable to determine event associated with apparent event "+"link element -- returning cell");return this.Super("getInteriorLocator",arguments)}
...
if(_43=="name"){this.locateRowsBy="targetCellValue"}else{this.locateRowsBy=_43}
var _47=this.getRowNumFromLocatorConfig(_23);return this.data.get(_47)}})}
